...
// Create the earthquake layer for our map. At line 25, this variable is empty. We don't add anything to it until much later
...
d3.json(earthQuakes).then(function(data) {
    L.geoJson(data, {
        ...
        // you are adding it to the new layerGroup object 'earthquakes', line 26
        }).addTo(earthquakes);
